...
/**
 * @title GoldVaultFactory
 * @dev Deploys GoldVault proxies for each Gold Token.
 */
contract GoldVaultFactory is 
    Initializable,
    UUPSUpgradeable,
    AccessControlUpgradeable 
{
    ...
    /**
     * @dev Deploy a new GoldVault PROXY for a given token.
     */
