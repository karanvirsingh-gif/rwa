    ...
    AbstractModule 
{
    ...
    IToken public token; // The Gold Token
     ...
     * @param amount The amount of gold tokens to buy
     */
    ...
    function _buyFor(address beneficiary, uint256 amount) internal {
        ...
        // Transfer gold tokens to beneficiary
    ...
    function name() external pure override returns (string memory) {
        return "GoldVaultDividendModule";
    }
